...
namespace SporC.DAL.Migrations
{
    ...
    [Migration("20231227215516_mig10")]
    partial class mig10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporC.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 28, 0, 55, 15, 907, DateTimeKind.Local).AddTicks(1800));
            ...
            modelBuilder.Entity("SporC.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 28, 0, 55, 15, 907, DateTimeKind.Local).AddTicks(4038));
            ...
            modelBuilder.Entity("SporC.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 28, 0, 55, 15, 907, DateTimeKind.Local).AddTicks(6083));
            ...
            modelBuilder.Entity("SporC.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 28, 0, 55, 15, 907, DateTimeKind.Local).AddTicks(8327));
            ...
            modelBuilder.Entity("SporC.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 28, 0, 55, 15, 906, DateTimeKind.Local).AddTicks(9369));
