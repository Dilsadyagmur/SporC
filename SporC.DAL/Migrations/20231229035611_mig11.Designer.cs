...
namespace SporC.DAL.Migrations
{
    ...
    [Migration("20231229035611_mig11")]
    partial class mig11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporC.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 29, 6, 56, 11, 51, DateTimeKind.Local).AddTicks(8930));
            ...
            modelBuilder.Entity("SporC.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 6, 56, 11, 52, DateTimeKind.Local).AddTicks(1687));
            ...
            modelBuilder.Entity("SporC.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 6, 56, 11, 52, DateTimeKind.Local).AddTicks(4207));
            ...
            modelBuilder.Entity("SporC.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 6, 56, 11, 52, DateTimeKind.Local).AddTicks(6417));
            ...
            modelBuilder.Entity("SporC.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 6, 56, 11, 51, DateTimeKind.Local).AddTicks(5395));
