...
namespace SporC.DAL.Migrations
{
    ...
    [Migration("20231003141511_ısdeleted")]
    partial class ısdeleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporC.Entities.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 3, 17, 15, 11, 275, DateTimeKind.Local).AddTicks(5443));
            ...
            modelBuilder.Entity("SporC.Entities.Concrete.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 3, 17, 15, 11, 275, DateTimeKind.Local).AddTicks(7347));
            ...
            modelBuilder.Entity("SporC.Entities.Concrete.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 3, 17, 15, 11, 275, DateTimeKind.Local).AddTicks(9309));
            ...
            modelBuilder.Entity("SporC.Entities.Concrete.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 3, 17, 15, 11, 276, DateTimeKind.Local).AddTicks(1301));
