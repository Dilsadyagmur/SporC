...
namespace SporC.DAL.Migrations
{
    ...
    [Migration("20231229042838_mig12")]
    partial class mig12
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporC.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 29, 7, 28, 38, 121, DateTimeKind.Local).AddTicks(7639));
            ...
            modelBuilder.Entity("SporC.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 7, 28, 38, 121, DateTimeKind.Local).AddTicks(9281));
            ...
            modelBuilder.Entity("SporC.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 7, 28, 38, 122, DateTimeKind.Local).AddTicks(958));
            ...
            modelBuilder.Entity("SporC.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 7, 28, 38, 122, DateTimeKind.Local).AddTicks(2811));
            ...
            modelBuilder.Entity("SporC.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 7, 28, 38, 121, DateTimeKind.Local).AddTicks(5569));
