...
namespace SporC.DAL.Migrations
{
    ...
    [Migration("20231229061239_mig13")]
    partial class mig13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SporC.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 29, 9, 12, 39, 540, DateTimeKind.Local).AddTicks(2484));
            ...
            modelBuilder.Entity("SporC.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 9, 12, 39, 540, DateTimeKind.Local).AddTicks(4225));
            ...
            modelBuilder.Entity("SporC.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 9, 12, 39, 540, DateTimeKind.Local).AddTicks(6000));
            ...
            modelBuilder.Entity("SporC.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 9, 12, 39, 540, DateTimeKind.Local).AddTicks(7896));
            ...
            modelBuilder.Entity("SporC.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 29, 9, 12, 39, 540, DateTimeKind.Local).AddTicks(302));
